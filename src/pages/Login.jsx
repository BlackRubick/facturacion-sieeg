...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-200 px-2">
      <div className="bg-white rounded-xl shadow-2xl border border-blue-100 p-0 sm:p-0 w-full max-w-md flex flex-col items-center">
        <img
        ...
        />
        <form onSubmit={handleSubmit} className="w-full px-8 pb-8 pt-4 flex flex-col items-center">
